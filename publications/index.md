...
{% include list.html data="citations" component="citation" style="rich" filter="group != 'featured' and date >= '2021-05-01' and ! title.downcase.include?('conference') and ! title.downcase.include?('proceeding') and ! publisher.downcase.include?('conference') and ! publisher.downcase.include?('proceeding')" %}